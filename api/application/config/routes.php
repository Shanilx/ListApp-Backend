...
//$route['user/bannerlist'] = 'User/sliderlist_get';
$route['login/bannerlist'] = 'Login/bannerlist';

$route['user-signup'] = 'Login/userSignup';

$route['user/getotp'] = 'User/getotp';

$route['user-profile-update'] = 'Login/userProfileUpdate';
