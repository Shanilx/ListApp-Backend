...

  {
...

    {
...

      {
        ...
        $final_data = array('error'=>'0','message'=>'Device Registered','data'=>'');
...

      {
        ...
        $final_data = array('error'=>'1','message'=>'Device Not Registered','data'=>'');
...
Team ListApp';
...

  {
...

    {
      ...
      {  
        ...
        $upd_arr = array('login_status' =>'0', 'device_token'=>'0');
...

  {
    ...
    if(empty($phone)  || empty($device_token) || empty($issue) || empty($description)|| empty($product_name))
