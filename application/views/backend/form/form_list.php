             ...
             <section class="panel">
                <header class="panel-heading">
                    ...
                    <span class="tools pull-right">
                        <a href="<?php echo base_url(); ?>apanel/Form/add" style="padding: 0px;"><button class="btn btn-primary __web-inspector-hide-shortcut__" type="button"><i class="fa fa-plus"></i> Add Form </button></a>
                ...
                <div class="panel-body">
                 <div class="adv-table">
                  <table  class="display table table-bordered table-striped" id="ajaxDataTableForm">
                     <thead>
                        <tr>
                            <th>#</th>
...
<script>
   function confirmDelete(id) {
    var delUrl ="<?php echo base_url('apanel/Form/DeleteForm/') ?>";
...
$("body").on("click",".Form_changeStatus",function(){
      ...
      if(confirm("Do you really want to "+action+" this Form ?"))
       {
         $.post("<?php echo base_url('apanel/Form/Form_changeStatus');?>",{ac:action,acid:actionid},function(response){
          // alert(response);return false;
          if(response == 'ok'){
             if(action == 'block'){
              // $("#statuscell_"+actionid).html("<span class='label label-danger'>Blocked</span>");
               $("#"+temp).attr("title","Activate this Form");
             ...
             {          
                        ...
                        $("#"+temp).attr("title","Block this Form");
    ...
    $(document).ready(function() {
      ...
      jQuery.fn.dataTableExt.oApi.fnFilterClear  = function ( oSettings )
        ...
        $('#ajaxDataTableForm').dataTable({
            ...
            "ajax": "<?php echo base_url('apanel/Form/ajaxDataTableForm')?>",
            //"pageLength":100,
            "order": [[ 0, "asc" ]],
            "aoColumnDefs": [
