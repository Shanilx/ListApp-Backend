...
{  
    ...
    <div class="wrapper">
        <div class="row">
             ...
             <section class="panel">
                <header class="panel-heading">
                    ...
                    <span class="tools pull-right">
                        <a href="<?php echo base_url(); ?>apanel/Notification/Add" style="padding: 0px;"><button class="btn btn-primary __web-inspector-hide-shortcut__" type="button"><i class="fa fa-plus"></i> Send Notification </button></a>
                ...
                <div class="panel-body">
                 <div class="adv-table">
                  <table  class="display table table-bordered table-striped dynamic_data_table" id="ajaxDataTableNotification">
                     <thead>
                        <tr>
                            <th>#</th>
            ...
            <!--body wrapper end-->
            <!-- Modal -->
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="NotificationModal" class="modal fade">
...
<script>
    ...
    var delUrl ="<?php echo base_url('apanel/Notification/DeleteNotification/') ?>";
 ...
 <script>
    ...
    $(document).ready(function() {
      jQuery.fn.dataTableExt.oApi.fnFilterClear  = function ( oSettings )
        ...
        $('#ajaxDataTableNotification').dataTable({
            //'processing': true,
            //'serverSide': true,  
             'bProcessing': true,          
                  'oLanguage': {
            ...
            "ajax": "<?php echo base_url('apanel/Notification/ajaxDataTableNotification')?>",
            "pageLength":100,
            "order": [[ 0, "asc" ]],
            "aoColumnDefs": [
