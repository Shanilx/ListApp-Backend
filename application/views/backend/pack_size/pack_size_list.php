             ...
             <section class="panel">
                <header class="panel-heading">
                    ...
                    <span class="tools pull-right">
                        <a href="<?php echo base_url(); ?>apanel/Packsize/add" style="padding: 0px;"><button class="btn btn-primary __web-inspector-hide-shortcut__" type="button"><i class="fa fa-plus"></i> Add Pack Size </button></a>
                ...
                <div class="panel-body">
                 <div class="adv-table">
                  <table  class="display table table-bordered table-striped" id="ajaxDataTablePacksize">
                     <thead>
                        <tr>
                            <th>#</th>
                            <th>Pack Size</th>
...
<script>
    ...
    var delUrl ="<?php echo base_url('apanel/Packsize/DeletePacksize/') ?>";
...
$("body").on("click",".Packsize_changeStatus",function(){
      ...
      if(confirm("Do you really want to "+action+" this Pack size ?"))
       {
         $.post("<?php echo base_url('apanel/Packsize/Packsize_changeStatus');?>",{ac:action,acid:actionid},function(response){
           //alert(response);return false;
          if(response == 'ok'){
             if(action == 'block'){
              // $("#statuscell_"+actionid).html("<span class='label label-danger'>Blocked</span>");
               $("#"+temp).attr("title","Activate this Pack size");
             ...
             {          
                        ...
                        $("#"+temp).attr("title","Block this Pack size");
...
<script>
    $(document).ready(function() {
      ...
      jQuery.fn.dataTableExt.oApi.fnFilterClear  = function ( oSettings )
        ...
        $('#ajaxDataTablePacksize').dataTable({
            //'processing': true,
            //'serverSide': true,
             'bProcessing': true,          
                  'oLanguage': {
            ...
            "ajax": "<?php echo base_url('apanel/Packsize/ajaxDataTablePacksize')?>",
            //"pageLength":100,
            "order": [[ 0, "asc" ]],
            "aoColumnDefs": [
