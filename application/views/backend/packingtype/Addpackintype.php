      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb panel">
                ...
                <li class="active">Add Packing Type</li>
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>
            ...
            <section class="panel">
             ...
             <div class="panel-body">
                <section class="panel">
                    <div class="panel-body">
                    <div class="col-md-12">
                       <form role="form" class="form-vertical" action="<?php echo base_url(); ?>apanel/Packingtype/AddPackingtype" method="post" id="add_Packingtype" name="add_Packingtype">
                        <div class="form-group col-md-2">
                          <label style="width:150px;">Packing Type Name<span class="error"> *</span></label>
                        </div>
                        <div class="form-group col-md-4">
                          <input type="text" name="Packingtype_name" id="Packingtype_name" class="form-control"/>
                        </div>
                        <div class="form-group col-md-4">
