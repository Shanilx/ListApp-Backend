             ...
             <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="adv-table">
                        ...
                        <form method="post" action="<?php echo base_url('apanel/slider-upload'); ?>" data-parsley-validate="" enctype="multipart/form-data" class="image_doc_upload_aadhar">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="form-group border border-secondary aadhaar_card">
                                        ...
                                        <input type="file" name="image_url" id="" class="dropify" data-height="100"  data-allowed-file-extensions="jpg jpeg png gif"  data-default-file="" data-max-file-size="4M" required="">
