...
$route['default_controller'] = 'backend/login/guestUser';
...
//------- route for app search log-----------

$route['apanel/product-search-log'] = 'backend/product/product_search_log';
$route['apanel/app-search/product'] = 'backend/App_search_history/index';
$route['apanel/app-search/company'] = 'backend/App_search_history/company_search';
$route['apanel/app-search/supplier'] = 'backend/App_search_history/supplier_search';

$route['apanel/city-search/city-list'] = 'backend/App_search_history/search_city_list';
$route['apanel/city-search/add'] = 'backend/App_search_history/city_add';
$route['apanel/city-search/add_city'] = 'backend/App_search_history/add_city';
$route['apanel/city-search/remove/(:num)'] = 'backend/App_search_history/remove_city/$1';
$route['apanel/city-search/check-city'] = 'backend/App_search_history/check_city';
...
$route['apanel/Supplier/Import'] = 'backend/Supplier/import_supplier';
...
$route['apanel/Retailer/Import'] = 'backend/Retailer/import_retailer';
$route['apanel/login-history/(:any)'] = 'backend/Retailer/login_history/$1';

//------------------------Post Routes------
$route['apanel/post'] = 'backend/Product_sell_post/index';
$route['apanel/post/delete_post/(:num)'] = 'backend/Product_sell_post/delete_post/$1';
$route['apanel/post/post_changeStatus'] = 'backend/Product_sell_post/post_changeStatus';
$route['apanel/post/post_detail/(:any)'] = 'backend/Product_sell_post/post_detail/$1';
$route['apanel/post/ajaxDataTablePost'] = 'backend/Product_sell_post/ajaxDataTablePost';
$route['apanel/post/export'] = 'backend/Product_sell_post/export_sell_post';

//------------------------Post Routes------
$route['apanel/hiring-post'] = 'backend/Hiring_post/index';
$route['apanel/hiring-post/delete_post/(:num)'] = 'backend/Hiring_post/delete_post/$1';
$route['apanel/hiring-post/ph_changeStatus'] = 'backend/Hiring_post/ph_changeStatus';
$route['apanel/hiring-post/here_detail/(:any)'] = 'backend/Hiring_post/post_detail/$1';
$route['apanel/hiring-post/ajaxDataTableHiring'] = 'backend/Hiring_post/ajaxDataTableHiring';
$route['apanel/hiring-post/export'] = 'backend/Hiring_post/export_hire_post';
