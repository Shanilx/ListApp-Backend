...
//print_r($notification_data);die;
    // mail('mukesh.syscraft@gmail.com','test','This is test smsm hhhhhhh');
     $ci =& get_instance();
    //$apiKey = 'AIzaSyDrlwqVQ4-1Ix5DeO05fY2KN-5Whq9-UcY';//AIzaSyDQsg_FGm167k04JlFBW6PHsnoWwBkPMXY //AIzaSyA4Stj9r694MCWk3rMMQwwJWITsHrDEWMI
    ...
    $badge=$ci->common_model->get_entry_by_data('m16j_notifications',false,array('device_token'=>$device_token,'is_read'=>'2'));
...
/*    
    $fields = array(
      ...
      'to'  => $reg_id ,
      'priority'=> "high",
            'notification' => array( "title"=>"Favourite by syscraft", "body" => $message )
        );
*/
