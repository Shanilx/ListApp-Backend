            ...
            <div class="col-sm-12">
             ...
             <section class="panel">
                ...
                <div class="panel-body">
                 <div class="adv-table">
                  <table  class="display table table-bordered table-striped" id="ajaxDataTableHiring" style="
...
$(document).ready(function() {
      jQuery.fn.dataTableExt.oApi.fnFilterClear  = function ( oSettings )
        ...
        $('#ajaxDataTableHiring').dataTable({
            ...
            "ajax": "<?php echo base_url('apanel/hiring-post/ajaxDataTableHiring')?>",
            //"pageLength":100,
            "order": [[ 0, "asc" ]],
            "aoColumnDefs": [
...
$("body").on("click",".ph_changeStatus",function(){
      ...
      if(confirm("Are you sure to "+action+" this Post ?"))
       {
         $.post("<?php echo base_url('apanel/hiring-post/ph_changeStatus');?>",{ac:action,acid:actionid},function(response){
...
$("body").on("click",".hiring_changeStatus",function(){
       var temp  =  $(this).attr('id');
       var temp2 = temp.split("_");
       var action = temp2[0];
       var actionid = temp2[1];
      if(confirm("Are you sure you want to set status "+action+" this Post ?"))
       {
         $.post("<?php echo base_url('backend/Hiring_post/hire_changeStatus');?>",{ac:action,acid:actionid},function(response){
          if(response == 'ok'){
            window.location.reload();
          }
        });
