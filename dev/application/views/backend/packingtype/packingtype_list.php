             ...
             <section class="panel">
                <header class="panel-heading">
                    ...
                    <span class="tools pull-right">
                        <a href="<?php echo base_url(); ?>apanel/Packingtype/add" style="padding: 0px;"><button class="btn btn-primary __web-inspector-hide-shortcut__" type="button"><i class="fa fa-plus"></i> Add Packing Type </button></a>
                ...
                <div class="panel-body">
                 <div class="adv-table">
                  <table  class="display table table-bordered table-striped" id="ajaxDataTable_packing">
                     <thead>
                        <tr>
                            <th>#</th>
                            <th>Packing Type</th>
...
<script>
    ...
    var delUrl ="<?php echo base_url('apanel/Packingtype/DeletePackingtype/') ?>";
...
$("body").on("click",".Packingtype_changeStatus",function(){
      ...
      if(confirm("Do you really want to "+action+" this Packing type ?"))
       {
         $.post("<?php echo base_url('apanel/Packingtype/Packingtype_changeStatus');?>",{ac:action,acid:actionid},function(response){
          // alert(response);return false;
          if(response == 'ok'){
             if(action == 'block'){
              // $("#statuscell_"+actionid).html("<span class='label label-danger'>Blocked</span>");
               $("#"+temp).attr("title","Activate this Packing type");
             ...
             {          
                        ...
                        $("#"+temp).attr("title","Block this Packing type");
...
<script>
    $(document).ready(function() {
      ...
      jQuery.fn.dataTableExt.oApi.fnFilterClear  = function ( oSettings )
        ...
        $('#ajaxDataTable_packing').dataTable({
            //'processing': true,
            //'serverSide': true,
             'bProcessing': true,          
                  'oLanguage': {
            ...
            "ajax": "<?php echo base_url('apanel/Packingtype/ajaxDataTablePacking')?>",
            "pageLength":10,
            "order": [[ 0, "asc" ]],
            "aoColumnDefs": [
