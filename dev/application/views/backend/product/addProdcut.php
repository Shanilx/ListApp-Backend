  ...
  <div class="wrapper">
    ...
    if($msg!="")
    {
                      ...
                      <div id="company_sug_box" ></div>
                                   ...
                                   <div class="col-md-12">
                                    <div class="form-group col-md-6">
                                      ...
                                      <input type="text" class="form-control" id="drug_name" name="drug_name" placeholder="Drug Name" >
                                    </div>
                                    <div class="form-group col-md-6" >
                                      <label for="exampleInputEmail1">Form</label>
                                      <input type="text" class="form-control" id="form_p" name="form_p" placeholder="Form" value="">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group col-md-6" >
                                      ...
                                      <input type="text" class="form-control" id="packing_type" name="packing_type" placeholder="Packing Type">
                                  ...
                                  <div class="col-md-12">
                                   <div class="form-group btn_align">
                                     <button type="submit" class="btn btn-primary add_product" id="add_product">Save</button>
                                     
                                     <button type="button" name="cancel" id="cancel" onClick="window.location.href='<?php echo base_url(); ?>apanel/product/1'" class="btn btn-primary" style="margin-left:10px;">Cancel</button>
                                   </div>
                                 </div>
     ...
     success: function (response) {
             ...
             {
              // alert("already exist");
              $('#form_product_error').html('This Product with this Form  Name Already Exist ');
            }
            else
            {
