    ...
    <div class="row">
      <div class="col-sm-12">
        <ul class="breadcrumb panel">
         ...
         <li><a href="<?php echo base_url().'apanel/Retailer'?>">Manage Retailer</li></a>
         <li>Import Retailer</li>
       </ul>
       <section class="panel">
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
               Import Retailer
               <a href="<?php echo base_url('uploads');?>/xlsx_sample_file/Sample Retailer File.xlsx" style="padding: 0px;float:right;"><button class="btn btn-success __web-inspector-hide-shortcut__" type="button" download>Download Sample File</button></a>
             </header>
             <div class="panel-body">
              <div class="form">
                <form class="cmxform form-horizontal adminex-form" id="upload_file_form" method="post" action="<?php echo base_url().'backend/Retailer/bulk_upload'?>" name="upload_file_form" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Upload XLSX File<span class="require_class">*</span></label>                    
                      <div class="col-sm-8">
                        <input type="file" class="form-control" name="csv_file" id="csv_file" /> <p id="valid_file" ></p>
                        <br><span>Note : Please use Sample XLSX file for Import Retailer</span>
                      </div>
                    </div>
                   <div class="col-sm-5" >
                     <p  id="loder_upload" style="display:none;margin-left: 162px; color: #27354a;"><i class='fa fa-spinner fa-pulse fa-3x fa-fw'></i><br><span>Uploading...</span></p>
...
var my_form_id        = '#upload_file_form'; //ID of an element for response output
...
/*  alert(res);
  ...
  if(res!='')
  {
   window.location.href = "<?php echo base_url();?>apanel/Retailer";
