       ...
       <section class="panel">
        <header class="panel-heading">
          ...
          <span class="tools pull-right">
           <a href="<?php echo base_url().'backend/Supplier/export_suplier'?>" style="padding: 0px;"><button class="btn btn-primary __web-inspector-hide-shortcut__" type="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Supplier</button></a>
           <a href="<?php echo base_url().'apanel/Supplier/Import'?>" style="padding: 0px;"><button class="btn btn-primary __web-inspector-hide-shortcut__" type="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Import Supplier</button></a>
