    ...
    <div class="row">
      <div class="col-sm-12">
        <ul class="breadcrumb panel">
         ...
         <li><a href="<?php echo base_url().'apanel/Supplier'?>">Manage Supplier</li></a>
          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
               Import Supplier
               <a href="<?php echo base_url('uploads');?>/xlsx_sample_file/Sample Supplier file.xlsx" style="padding: 0px;float:right;"><button class="btn btn-success __web-inspector-hide-shortcut__" type="button" download>Download Sample File</button></a>
             </header>
             <div class="panel-body">
              <div class="form">
                <form class="cmxform form-horizontal adminex-form" id="upload_file_form" method="post" action="<?php echo base_url().'backend/Supplier/bulk_upload'?>" name="upload_file_form" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Upload XLSX File<span class="require_class">*</span></label>                    
                      <div class="col-sm-8">
                        ...
                        <br><span>Note : Please use Sample XLSX file for Import Supplier</span>
                      </div>
                    </div>
                   <div class="col-sm-5" >
