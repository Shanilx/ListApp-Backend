...
Login.prototype.setListeners = function(){
    ...
    loginForm.addEventListener('submit', function(e){
        ...
        var qb_id=document.getElementById('chat_qb_id').value;
        var qb_login=document.getElementById('chat_qb_login').value;
        var qb_password=document.getElementById('chat_qb_password').value;
        var full_name=document.getElementById('chat_full_name').value;
